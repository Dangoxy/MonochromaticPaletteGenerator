            ...
            >
                <div class="flex phone:flex-row flex-col gap-2 justify-center items-center">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a class="hover:scale-105 transition-colors duration-500" target="_blank" href="https://github.com/Dangoxy">
                            <svg 
                        ...
                        <a class="hover:scale-105 transition-colors duration-500" target="_blank" href="https://www.linkedin.com/in/ammar-abdelwadoud-20457a272/">
                            <svg 
                            class="transition-colors duration-500"
                            :fill="
                            (palette.length !==0 && palette.length > 8) && darkmode.toggle && (rgb.r > 155 || rgb.g > 155 || rgb.b > 155) ? 
